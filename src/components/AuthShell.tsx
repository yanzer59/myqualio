...
export default function AuthShell({ children }: { children: React.ReactNode }) {
  ...
  // Mode hors-ligne (sans Supabase) — affiche l'app directement avec sidebar
  if (configError) {
    return (
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 flex flex-col">
          <div className="bg-white border-b border-gray-200 px-6 py-2.5 flex items-center justify-end gap-3 shrink-0">
            <span className="text-xs bg-orange/10 text-orange px-2 py-1 rounded">Mode hors-ligne (localStorage)</span>
          </div>
